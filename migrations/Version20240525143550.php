 ...
 */
final class Version20240525143550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT NOT NULL, warehouse_id INT NOT NULL, name VARCHAR(255) NOT NULL, size VARCHAR(255) NOT NULL, unique_code VARCHAR(255) NOT NULL, quantity INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_D34A04AD5080ECDE ON product (warehouse_id)');
        $this->addSql('CREATE TABLE warehouse (id INT NOT NULL, name VARCHAR(255) NOT NULL, is_avaible BOOLEAN NOT NULL, PRIMARY KEY(id))');
